  ...
  items: [
    {
      ...
      type: "text",
      value:
        "Decidiste crear tu propia aplicación web, tenés la tarea de definir los lineamientos del proyecto...",
    },
    {
      id: 2,
      type: "title",
    ...
    },
    {
      ...
      type: "text",
      value:
        "El minimalismo en interfaces no es simplemente eliminar elementos: es diseñar con intención. Cada componente debe existir para resolver una necesidad concreta, reducir la carga cognitiva y facilitar la acción del usuario sin sacrificar la usabilidad.",
    },
    {
      id: 4,
      type: "list",
    ...
    },
    {
      ...
      type: "quote",
      value:
        "“Menos, pero mejor.” — Principio aplicable al diseño de interfaces: reducir ruido para amplificar la función.",
    },
    {
      id: 9,
      type: "title",
    ...
    },
    {
      ...
      type: "text",
      value:
        "Elige una o dos familias tipográficas legibles. Define una escala tipográfica clara (título, subtítulo, cuerpo, meta). El contraste suficiente entre texto y fondo es esencial: la estética minimalista no debe sacrificar accesibilidad.",
    },
    {
      id: 11,
      type: "table",
    ...
    },
    {
      ...
      value: [
        ...
        {
          id: 2,
          text: "Tarjetas de contenido con jerarquía clara (título, resumen, CTA)",
        },
        {
          id: 3,
          text: "Barra de navegación simplificada con máximo 5 opciones",
        },
        {
          id: 4,
          text: "Estados y mensajes claros para acciones (éxito, error, carga)",
        },
      ],
    },
    {
...
.btn-primary:hover {
    ...
    },
    {
      ...
      type: "text",
      value:
        "Diseña sistemas de componentes donde las variantes se controlen por configuración (color, tamaño, icono). Esto permite mantener consistencia y reducir código duplicado, clave para mantener una UI minimalista mantenible.",
    },
    {
      id: 16,
      type: "title",
    ...
    },
    {
      ...
      type: "text",
      value:
        "Minimalismo y accesibilidad van de la mano: texto legible, contraste, foco visible y navegación por teclado. Un diseño simple suele mejorar el rendimiento — menos assets, menos peticiones, y tiempos de interacción más rápidos.",
    },
    {
      id: 18,
      type: "quote",
    ...
    },
    {
      ...
      type: "text",
      value:
        "Conclusión: diseñar interfaces minimalistas es un ejercicio de disciplina y priorización. No se trata de un estilo frío, sino de diseñar con intención para que la funcionalidad y la experiencia del usuario sean claras y eficaces.",
    },
    {
      id: 22,
      type: "title",
    ...
    },
    {
      ...
      value: [
        ...
        {
          id: 3,
          text: "Artículos sobre diseño centrado en tareas y sistemas de diseño",
        },
      ],
    },
  ],
