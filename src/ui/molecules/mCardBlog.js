...
export default function MCardBlog({ data }) {
    return (
        <ALink href={data.href}>
            <motion.article
                className="flex justify-between cursor-pointer border-b-4 border-[#181818] p-4 hover:shadow-lg hover:bg-[#111111] hover:scale-102 duration-300 transition-all rounded-4xl"
