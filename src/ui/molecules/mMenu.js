...
export default function MMenu({ data, isOpen = false, onClose }) {
  return (
    <nav aria-label="Menú principal" className="relative">
      <ul
        className={`fixed top-20 left-0 z-40 flex h-full w-full flex-col items-center justify-center gap-5 bg-[#121212] p-8 transition-all duration-500 ease-in-out lg:static lg:h-auto lg:flex-row lg:bg-transparent lg:p-0 ${
          isOpen
